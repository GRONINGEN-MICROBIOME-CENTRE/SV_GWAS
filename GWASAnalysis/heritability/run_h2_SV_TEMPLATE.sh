...
mgrm=/groups/umcg-lifelines/tmp01/projects/dag3_fecal_mgs/umcg-dzhernakova/genotypes/DAG3/GCTA/mgrm.txt
gender_file=/groups/umcg-lifelines/tmp01/projects/ov20_0051/umcg-dzhernakova/LL_genotypes/UGLI_mgs_v1/DAG3_gender.txt
...
awk -v c=$col_cov 'BEGIN {FS=OFS="\t"}; {print $1, $2, $c, $115, $116}' ${pheno_dir}/DAG3.covariates.plink19.noheader.txt \
