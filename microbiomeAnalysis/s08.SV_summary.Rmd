...
```{r 1.2, echo=TRUE}
# SVs
load("../../202102_SV_full/history/analysis.v1.0/SV_full/01.cleanData/SV_dag3/vsgv_dag3.RData")
load("../../202102_SV_full/history/analysis.v1.0/SV_full/01.cleanData/SV_dag3/dsgv_dag3.RData")
load("../../202102_SV_full/history/analysis.v1.0/SV_full/01.cleanData/SV_lld1/vsgv_lld1.RData")
load("../../202102_SV_full/history/analysis.v1.0/SV_full/01.cleanData/SV_lld1/dsgv_lld1.RData")
load("../../202102_SV_full/history/analysis.v1.0/SV_full/01.cleanData/SV_ffg/vsgv_ffg.RData")
load("../../202102_SV_full/history/analysis.v1.0/SV_full/01.cleanData/SV_ffg/dsgv_ffg.RData")
load("../../202102_SV_full/history/analysis.v1.0/SV_full/01.cleanData/SV_tob/vsgv_tob.RData")
load("../../202102_SV_full/history/analysis.v1.0/SV_full/01.cleanData/SV_tob/dsgv_tob.RData")

# abundance
abun_dag3<-read.table("../../202102_SV_full/history/analysis.v1.0/SV_full/01.cleanData/mbio/DAG3_SV_species_8047samples.tsv",
                      sep = "\t", check.names = F)
abun_lld1<-read.table("../../202102_SV_full/history/analysis.v1.0/SV_full/01.cleanData/mbio/LLD1_SV_species_1135samples.tsv",
                      sep = "\t", check.names = F)
abun_ffg<-read.table("../../202102_SV_full/history/analysis.v1.0/SV_full/01.cleanData/mbio/500FG_SV_species_450samples.tsv",
                      sep = "\t", check.names = F)
abun_tob<-read.table("../../202102_SV_full/history/analysis.v1.0/SV_full/01.cleanData/mbio/300OB_SV_species_302samples.tsv",
                      sep = "\t", check.names = F)

load("../../202102_SV_full/history/analysis.v1.0/SV_full/01.cleanData/SV_info/info.RData")
vsgv_info <- read.table("../../202102_SV_full/history/analysis.v1.0/SV_full/01.cleanData/SV_info/20211212_full_vsgv_info_anno.tsv", 
                        sep = "\t", header = T, quote = "")
dsgv_info <- read.table("../../202102_SV_full/history/analysis.v1.0/SV_full/01.cleanData/SV_info/20211212_full_dsgv_info_anno.tsv", 
                        sep = "\t", header = T, quote = "")
...
if(!dir.exists("08.SV_summary")){dir.create("08.SV_summary")}
pdf("08.SV_summary/sv_abun_density.pdf", width = 6, height = 3)
...
pdf("08.SV_summary/SV_full_Total_SVs_number.pdf",height = 6, width = 6)
print(p_pie)
dev.off()
...
pdf("08.SV_summary/SV_full_SVs_number_species.pdf", height = 6, width = 16)
print(p_sv_species)
dev.off()
...
pdf("08.SV_summary/SV_full_Samples_number_species.pdf", height = 9, width = 16) 
print(p_sample_n)
dev.off()
...
pdf("08.SV_summary/SV_filtered_Total_SVs_number.pdf",height = 6, width = 6)
print(p_pie)
dev.off()
...
pdf("08.SV_summary/SV_filtered_SVs_number_species.pdf", height = 4.5, width = 10)
print(p_sv_species)
dev.off()
